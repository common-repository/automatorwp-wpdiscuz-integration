...
class AutomatorWP_wpDiscuz_Vote_Comment extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User votes up/down a comment', 'automatorwp-wpdiscuz-integration' ),
            'select_option'     => __( 'User <strong>votes up/down</strong> a comment', 'automatorwp-wpdiscuz-integration' ),
            /* translators: %1$s: Vote Up/Down. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User %1$s a comment %2$s time(s)', 'automatorwp-wpdiscuz-integration' ), '{vote}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User %1$s a comment', 'automatorwp-wpdiscuz-integration' ), '{vote}' ),
                ...
                'vote' => array(
                    ...
                    'fields' => array(
                        'vote' => array(
                            ...
                            'type' => 'select',
                            'options' => array(
                                'vote_up' => __( 'votes up', 'automatorwp-wpdiscuz-integration' ),
                                'vote_down' => __( 'votes down', 'automatorwp-wpdiscuz-integration' ),
                            ),
                            'default' => 'vote_up'
                        )
                    )
